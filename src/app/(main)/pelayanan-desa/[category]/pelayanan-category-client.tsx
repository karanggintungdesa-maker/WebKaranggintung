          ...
          <div className="grid md:grid-cols-3 gap-8 mb-10">
            ...
            <Card className="md:col-span-2 rounded-[2.5rem] bg-white border p-8 flex flex-col justify-center">
              ...
              <p className="text-slate-600 leading-relaxed">
                Berdasarkan hasil survei periode terakhir, tingkat kepuasan masyarakat Desa Karanggintung menunjukkan tren positif terutama pada aspek kesopanan petugas and kecepatan waktu penyelesaian dokumen.
              </p>
            </Card>
          </div>
        );
