      ...
      <Card className="w-full max-w-md shadow-xl border-emerald-100">
        <CardHeader className="text-center space-y-4">
          ...
          <div className="space-y-2">
            <CardTitle className="text-2xl font-bold text-emerald-950">Portal Layanan Digital</CardTitle>
        ...
        <CardContent>
          <Button onClick={() => router.push('/dashboard')} className="w-full h-12 bg-emerald-700 hover:bg-emerald-800 text-lg font-semibold">
            Masuk ke Dashboard
